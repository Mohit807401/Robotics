...
void loop(){
  ...
  if(error == 0){
    ...
    if(gyro_check_byte == 0b00000111){
      ...
      Serial.println(F("Gyro exes verification failed!!!"));
      error = 1;
    }
  }     
  ...
  if(error == 0){
    ...
    Serial.println(F("You can now calibrate the esc's (move to stage 2)"));
  }
  else{
...
void intro(){
  ...
  Serial.println(F("  to"));
  delay(500);
  Serial.println(F("    CIIE Drone"));
  delay(500);
  Serial.println(F("      Workshop"));
  delay(1000);
  Serial.println(F(""));
  ...
  Serial.println(F("==================================================="));
  delay(1500);
  Serial.println(F("Have a Safe and Successful Flight"));
  Serial.println(F(""));
}
